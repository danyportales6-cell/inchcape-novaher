...
const datosSenales = [
  { id: 1, img: "/UNION.png", texto: "Comentarios sobre apariencia o vida personal" },
  { id: 2, img: "/SEPARADO.png", texto: "Exclusión en reuniones o decisiones importantes" },
  { id: 3, img: "/EXTRA.png", texto: "Asignación de tareas imposibles o sin sentido" },
  { id: 4, img: "/FALTA.png", texto: "Limitación de crecimiento laboral" },
  { id: 5, img: "/COMENTARIOS.png", texto: "Críticas constantes y descalificación pública" },
  { id: 6, img: "/OCULTAR.png", texto: "Ocultación de información necesaria para el trabajo" },
];
...
const SECCION3 = () => {
  ...
  const prevSlide = () => {
    if (index > 0) {
      ...
      const ultimoIndex = isMobile ? datosSenales.length - 1 : datosSenales.length - 2;
    ...
    <section className="seccion-senales-root">
      <div className="contenedor-flex-senales">
        ...
        <div className="bloque-texto-controles">
            ...
            <p className="subtitulo-senales">ACOSO / DISCRIMINACIÓN</p>
            <p className="descripcion-senales">
              Son comportamientos o actitudes que pueden indicar un ambiente laboral inadecuado.
            </p>
            
            <div className="controles-carrusel">
              <button onClick={prevSlide} className="boton-carrusel"><ArrowLeft /></button>
              <button onClick={nextSlide} className="boton-carrusel"><ArrowRight /></button>
            </div>
        </div>
