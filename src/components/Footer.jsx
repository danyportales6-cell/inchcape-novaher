      ...
      <div className="max-w-7xl mx-auto px-6 py-16 grid gap-10 md:grid-cols-3">
        ...
        <div className="flex flex-col items-start gap-4 ">
          ...
          <p className="text-sm mt-3 text-gray-400">
            Impulsamos una cultura donde el respeto no es opcional, es la base de todo.
          </p>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            ...
            <li><a href="https://www.inchcape.com/es-co/nuestra-empresa/en-una-mirada" className="hover:text-cyan-400">Inchcape en una mirada</a></li>
            <li><a href="/acciones" className="hover:text-cyan-400">Entendiendo el problema</a></li>
            <li><a href="/reportar" className="hover:text-cyan-400">Atención de casos</a></li>
            <li><a href="https://www.inchcape.com/es-co/sostenibilidad" className="hover:text-cyan-400">Sostenibilidad</a></li>
          </ul>
        </div>
      ...
      <div className="border-t border-gray-700 py-6 px-6">
        <div className="max-w-7xl mx-auto flex flex-col gap-4 items-center text-sm">
          ...
          <div className="flex flex-wrap justify-center gap-8">
            ...
            <a href="https://www.inchcape.com/es-co/site-services/politica-de-privacidad" className="hover:text-cyan-400">Informacion Legal</a>
