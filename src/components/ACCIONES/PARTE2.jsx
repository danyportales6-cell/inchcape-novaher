...
const cardData = [
  ...
  },
  {
    ...
    summaryText: 'Estamos comprometidos a prevenir la discriminación y a proporcionar un lugar de trabajo comprensivo, respetuoso e inclusivo para todos. El respeto mutuo en el trabajo respalda la forma en que Inchcape trabaja.',
  ...
  },
  {
    ...
    summaryText: 'Apreciamos la contribución y singularidad de cada colaborador en su trabajo, apreciamos el trabajo que realizan y eso es lo que tomamos en cuenta.',
    ...
    title: 'ANTIACOSO.S.',
    summaryText: 'Garantizamos un ambiente seguro y respetuoso para todos nuestros colaboradores, mostrando seguridad y confianza en su entorno laboral. ',
      ...
      <div className="left-panel">
        ...
        <div className="integrity-section">
          ...
          <blockquote className="testimonial">
            Soy una técnica de 26 años. En mi lugar de trabajo anterior me sentía excluida y discriminada. En Inchcape soy parte del equipo y me siento valorada y respetada. Somos extremadamente profesionales y también nos divertimos; es un gran ambiente para trabajar. Nadie se siente amenazado ni intimidado.”
          </blockquote>
        </div>
      </div>
